...
-- These are only meant to be called by edge functions (service_role) or via RLS/triggers.
...
-- 3. am_i_admin is called from the admin UI by signed-in users; keep authenticated only.
