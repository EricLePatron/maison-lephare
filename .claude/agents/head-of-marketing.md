...
> **⚠️ Plugin désactivé par défaut.** Avant une session marketing, activer avec :
> ```bash
> claude plugin enable marketing-skills@marketingskills
> ```
> Désactiver après la session :
> ```bash
> claude plugin disable marketing-skills@marketingskills
> ```
