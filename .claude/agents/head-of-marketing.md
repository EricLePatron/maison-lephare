...
4. **Travailler avec les autres agents** — déléguer l'implémentation à Claude, coordonner avec `ux-designer` pour les changements visuels, utiliser `analytics` pour les données.
